...
class ShippingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping" do
    assert_difference('Shipping.count') do
      post shippings_url, params: { shipping: { express: @shipping.express, standard: @shipping.standard } }
    end
  ...
  test "should update shipping" do
    patch shipping_url(@shipping), params: { shipping: { express: @shipping.express, standard: @shipping.standard } }
